...
__all__ = [
    "PARIS_COLOR", "LONDON_COLOR", "LONDON_START_YEAR", "LONDON_END_YEAR",
    "create_point_from_coords", "parse_paris_coords", "convert_geojson_to_shape",
    "fit_polynomial_models", "fit_best_model", "secret_observation",
    "plot_airbnb_density_scatter_comparison",
    "plot_bias_variance_tradeoff_comparison",
    "plot_polynomial_regression_comparison",
    "plot_density_distribution_comparison",
    "plot_boxplot_comparison",
    "plot_quadratic_fit_comparison",
    "plot_correlation_bar_chart",
    "plot_london_price_comparisons",
]